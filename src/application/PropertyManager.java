...
public class PropertyManager {
	...
	public LinkedProperties getProperties() { return properties; }
	public void setProperties(LinkedProperties properties) { this.properties = properties; }

	public InputStream getInput() { return input; }
	public void setInput(InputStream input) { this.input = input; }

	public Transliteration getRules() { return rules; }
	public void setRules(Transliteration rules) { this.rules = rules; }
