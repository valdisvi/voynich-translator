...
public class addController {
	...
	public void initialize() throws IOException {
		File[] allProperties;
		File[] arrfile = allProperties = this.finder(Main.dataFolder);
	...
	public void selectTable() throws FileNotFoundException, IOException {
		 ...
		 * FileReader("../VoynichData/"+this.selectExistingTable.getValue()))) {
		...
		try {
			BufferedReader br = new BufferedReader(
					new FileReader(Main.dataFolder + "/" + this.selectExistingTable.getValue()));
			try {
	...
	public void addSaveButtonAction() {
		...
		if (addTableNameTextField.getText().equals("")) {
			...
			alert.show();
				...
				|| addTableNameTextField.getText().equals("Bennett") || addTableNameTextField.getText().equals("FSG")) {
			Alert alert = new Alert(AlertType.ERROR);
			alert.setTitle("Error");
	...
	public void writeToFile() {
		try (FileWriter writer = new FileWriter(
				new File(Main.dataFolder + "/" + this.addTableNameTextField.getText() + ".properties"), false)) {
